...
% Case 1 - Epsilon MOEA (without constraint normalization)
...
% Case 2 - Epsilon MOEA (with constraint normalization)
...
[feas_struct_case1, conn_struct_case1, stiffrat_struct_case1, partcoll_struct_case1, nodalprop_struct_case1, orient_struct_case1] = get_heuristic_scores_oa(fibre_model_used, case1_partcoll_bools, case1_nodalprop_bools, case1_orient_bools, constrad_read, sidenum, with_norm1, num_runs, pop_size);
[feas_struct_case2, conn_struct_case2, stiffrat_struct_case2, partcoll_struct_case2, nodalprop_struct_case2, orient_struct_case2] = get_heuristic_scores_oa(fibre_model_used, case2_partcoll_bools, case2_nodalprop_bools, case2_orient_bools, constrad_read, sidenum, with_norm2, num_runs, pop_size);
...
figure
boxplot(conn_array_all_case1,conn_case1_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Connectivity Score')
title('Connectivity Score Boxplot for Case 1')
...
figure
boxplot(stiffrat_array_all_case1,stiffrat_case1_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Absolute Stiffness Ratio Difference')
title('Stiffness Ratio Constraint Boxplot for Case 1')
...
figure
boxplot(partcoll_array_all_case1,partcoll_case1_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Partial Collapsibility Score')
title('Partial Collapsibility Score Boxplot for Case 1')
...
figure
boxplot(nodalprop_array_all_case1,nodalprop_case1_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Nodal Properties Score')
title('Nodal Properties Score Boxplot for Case 1')
...
figure
boxplot(conn_array_all_case2,conn_case2_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Connectivity Score')
title('Connectivity Score Boxplot for Case 2')
...
figure
boxplot(stiffrat_array_all_case2,stiffrat_case2_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Absolute Stiffness Ratio Difference')
title('Stiffness Ratio Constraint Boxplot for Case 2')
...
figure
boxplot(partcoll_array_all_case2,partcoll_case2_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Partial Collapsibility Score')
title('Partial Collapsibility Score Boxplot for Case 2')
...
figure
boxplot(nodalprop_array_all_case2,nodalprop_case2_groups,'Labels',labels)
xlabel('Run Number')
ylabel('Nodal Properties Score')
title('Nodal Properties Score Boxplot for Case 2')
...
case_labels = {'Without Normalization','With Normalization'};
...
%% Functions
function [feas_struct_all, conn_struct_all, stiffrat_struct_all, partcoll_struct_all, nodalprop_struct_all, orient_struct_all] = get_heuristic_scores_oa(fib_stiff, partcoll_bools, nodalprop_bools, orient_bools, constrad_read, sidenum, read_norm, n_runs, n_pop)
    ...
    if read_norm
        filepath_norm = "With normalization\\";
    else
        filepath_norm = "Without normalization\\";
    end
    ...
    for i = 1:n_runs
        ...
        full_filepath = strcat(filepath,filepath_constrad,filepath2,filepath_moea,filepath3,filepath_norm,filename,num2str(run_num),filename2);
        ...
        conn_array = csv_data_array(:,6);
        stiffrat_array = csv_data_array(:,7);
        partcoll_array = csv_data_array(:,8);
        nodalprop_array = csv_data_array(:,9);
        orient_array = csv_data_array(:,10);
