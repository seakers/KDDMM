...
% This function is intended for use with periodic boundary conditions
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
function conConstScore = connectivityConstraint_PBC_2D(sidenum,NC,CA,sel,biasFac)
