...
/**
 * Repair operator for the variable radii problem that improves design feasibility. Two operating modes are available
 * depending on whether design stability is also to be considered
 *
 * @author roshan94
 */

public class RemoveIntersectionVariableRadii implements Variation {
    ...
    public RemoveIntersectionVariableRadii(boolean KeepStable, MatlabEngine eng, double[][] nodalConnArray, double sidenum, double sel, double[] radiusLowerBounds, double[] radiusUpperBounds, double smallestRadiusFactor){
    ...
    public Solution[] evolve(Solution[] sols) {
        ...
        VariableRadiiRepeatableArchitecture newArchitecture;
    ...
    private double getTrussIndexToDelete (int[][] designConnectivityArray, int[][] fullConnectivityArray, double[][] intersectingTrusses) throws ExecutionException, InterruptedException {
        ...
        int[] trussPairToRemove = designConnectivityArray[(int) trussIndexToRemove];
    ...
    private int[][] getNewConnectivityArray(int[][] designConnectivityArray, double trussIndexToRemove) throws ExecutionException, InterruptedException {
    ...
    private double[][] findIntersectingTrusses (int[][] designConnectivityArray) throws ExecutionException, InterruptedException {
