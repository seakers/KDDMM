...
public class AddMemberIntegerRadii implements Variation{
    ...
    public AddMemberIntegerRadii(boolean keepFeasible, double[] radii, double[] youngsModulii, MatlabEngine eng, double[][] nodalConnArray, double sidenum, double sel, int numHeurObjectives, int numHeurConstraints) {
