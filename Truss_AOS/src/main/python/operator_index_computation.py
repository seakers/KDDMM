...
for i in range(n_runs):
    #obj_bounds_run = [objs1_max_allruns[i], objs1_min_allruns[i], objs2_max_allruns[i], objs2_min_allruns[i]]
    ...
    #I_pci, I_npi, I_orienti, I_intersi = compute_indices(data_comb_i, truss_problem, obj_bounds_run, only_hv_truss)
    I_pc[i] = I_pci
    I_np[i] = I_npi
