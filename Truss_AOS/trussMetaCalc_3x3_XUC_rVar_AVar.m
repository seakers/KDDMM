% -----------------------------------------------------------------
% Function for calculating metamaterial properties for a 2D 3x3 truss with
% individually-adjustable element radii, for any number of repeating unit
% cells in a square
% -----------------------------------------------------------------
...
%}
function [C,volFrac] = ...
              trussMetaCalc_3x3_XUC_rVar_AVar(nucFac,sel,tinyrvar,E,tinyCA)
